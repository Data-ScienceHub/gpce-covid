from data_preparation_alt import DataPrep
import json
import argparse
...
def main():
    ...
    dp = DataPrep(config['TFTparams']['data'], args.dataPath)#'/Users/andrejerkelens/Desktop/HiDT/git_repo/HiDimensionalTransformer/COVIDJuly2020/CovidDecember12-2021')
