...
def main(expt_name:str,
  ...
  print('Samples Train Valid ' + str(train_samples) + ' ' + str(valid_samples))
  print('Train Valid Test ' + str(train.shape) + ' ' + str(valid.shape) + ' ' + str(test.shape))
  ...
  fixed_params['early_stopping_patience'] = 100
