...
# %%
plotter = PlotResults(f'{args.figPath}_best', targets)
...
# %%
plotWeights = PlotWeights(args.figPath+'_best', parameters)
...
train_interpretation = best_tft.interpret_output(train_raw_predictions)
for key in train_interpretation.keys():
    print(key, train_interpretation[key].shape)
